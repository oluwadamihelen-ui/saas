...
export const metadata = { title: "Contact — Schoolum" };
    ...
    >
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        ...
        <div className="flex flex-col items-start gap-3 rounded-lg border border-border bg-surface p-6">
          ...
          <p className="flex-1 text-sm leading-relaxed text-muted">
            Already using Schoolum? Sign in and send us a note from the Feedback section of your dashboard — it goes straight to your school&apos;s admins and our team.
          </p>
          <Button asChild size="sm" variant="secondary">
        ...
        <div className="flex flex-col items-start gap-3 rounded-lg border border-border bg-surface p-6">
          ...
          <p className="flex-1 text-sm leading-relaxed text-muted">
            Take a look at how Schoolum works and what&apos;s included in each plan before you decide.
          </p>
          <Button asChild size="sm" variant="secondary">
