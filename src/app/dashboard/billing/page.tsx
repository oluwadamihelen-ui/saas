    ...
    return (
      <div className="max-w-3xl space-y-4 sm:space-y-6">
        <div>
          ...
          <p className="text-sm text-muted">Your school&apos;s subscription with Schoolum.</p>
        </div>
        <Card>
          <CardContent className="p-8">
            <EmptyState title="No subscription on record" description="Contact Schoolum support if you believe this is a mistake." />
          </CardContent>
        </Card>
      </div>
    );
