...
export const PERMISSIONS = {
  ...
  PRESCHOOL_MILESTONES_MANAGE: "preschool.milestones_manage",
...
export const PERMISSION_CATALOG: { key: PermissionKey; module: string; description: string }[] = [
  ...
  { key: PERMISSIONS.PRESCHOOL_MILESTONES_MANAGE, module: "results", description: "Create and edit the Scheme of Work and its milestones for Pre-School Results" },
...
export const ROLE_DEFAULT_PERMISSIONS: Record<SystemRoleKey, PermissionKey[]> = {
  ...
  PRINCIPAL: [
    ...
    PERMISSIONS.PRESCHOOL_MILESTONES_MANAGE,
