...
Schoolum Montessori School's AI-native school management platform —
...
- A platform Super Admin — one global account, not tied to any school —
  ...
  this account
- This bills the *school* for using Schoolum — a completely separate thing
...
- Schools pay Schoolum through the same `PaymentProvider` abstraction the
...
- Branding (Dashboard → Settings): upload a logo and pick a brand color —
  ...
  up keeps the default Schoolum look
...
The seed script creates **Schoolum Montessori School** (Creche, Nursery &
...
| Role | Email |
|---|---|
| School Owner | owner@horizon.demo |
| School Administrator | admin@horizon.demo |
| Head of School | principal@horizon.demo |
| Teacher | teacher1@horizon.demo / teacher2@horizon.demo |
| Accountant | accountant@horizon.demo |
| HR Staff | hr@horizon.demo |
| Librarian | librarian@horizon.demo |
| Transport Manager | transport@horizon.demo |
| Parent (portal) | parent@horizon.demo |
| Student (portal) | student@horizon.demo |
| Platform Super Admin | superadmin@schoolum.demo |
