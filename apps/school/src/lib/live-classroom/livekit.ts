...
/// attendance, recordings metadata — is entirely Winfield's own code. A
/// student or teacher never sees LiveKit's own UI, never creates a LiveKit
/// account, and is never redirected off Winfield: the browser connects
...
/// room and one already-authenticated, already-authorized Winfield user.
