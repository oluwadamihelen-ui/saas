...
export function WhyWinfield() {
  return (
    <section id="why-winfield" className="scroll-mt-20 py-20 sm:py-28">
      <div className="container-shell">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
          <Reveal>
            <p className="text-sm font-medium uppercase tracking-wide text-accent">Why Winfield</p>
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">
              Built for the way modern schools work.
            </h2>
            <p className="mt-4 max-w-md text-base leading-relaxed text-muted">
              Winfield replaces disconnected spreadsheets and manual processes with one platform your whole school
              team can rely on — from the front office to the classroom.
            </p>
          </Reveal>
