...
export default async function StudentFeedbackPage({ searchParams }: { searchParams: Promise<{ page?: string }> }) {
      ...
      {total > 0 && (
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Pagination page={page} pageCount={pageCount} basePath="/portal/student/feedback" />
          </CardContent>
        </Card>
      )}
    </div>
