...
export const metadata = { title: "Help Center — Winfield" };
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "No. Winfield is multi-tenant: every school's students, staff, finances and results are isolated from every other school, enforced on the server for every request — not just hidden in the interface.",
  },
  {
