...
import { WhyWinfield } from "@/components/marketing/why-winfield";
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <Reveal delayMs={140}>
                <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-muted">
                  Winfield brings students, staff, academics, attendance, finance and communication together in one
