...
import { changePlanAdmin, type HostingActionState } from "../actions";
...
export function ChangePlanForm({
  ...
  const [state, formAction, isPending] = useActionState(changePlanAdmin.bind(null, accountId), initial);
