...
import { z } from "zod";
import { setEpisodePrice, NotContentOwnerError, PriceOutOfRangeError, InvalidMonetizationConfigError } from "@/lib/monetization";
...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    await setEpisodePrice(userId, params.id, coinPrice);
